resource "aws_iam_role" "ciscomcd_fw_role" {
...
resource "aws_iam_role_policy" "ciscomcd_fw_policy" {
  name = "${var.prefix}_fw_policy"
  role = aws_iam_role.ciscomcd_fw_role.id
...
resource "aws_iam_instance_profile" "ciscomcd_fw_role" {
  name = "${var.prefix}-firewall-role"
  role = aws_iam_role.ciscomcd_fw_role.name
}
